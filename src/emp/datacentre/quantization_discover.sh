#!/bin/bash
# Set parameters.
topology=rrg #rrg/dring/leafspine
routing=$1
trafficmatrix=16to4-1
mode=$2 #equal/weighted/lppbr/lpdbr/lppbr-optimal/lpdbr-optimal/lppbr-nox-optimal/lpdbr-nox-optimal/lppbr-nox-delay/lpdbr-nox-delay/lppbr-delay/lpdbr-delay/lppbr-nox/lpdbr-nox
...
then
  ...
  elif [ $mode = "lppbr" ] || [ $mode = "lppbr-p8" ] || [ $mode = "lppbr-p16" ] || [ $mode = "lppbr-p32" ] || [ $mode = "lppbr-p64" ] || [ $mode = "lppbr-p128" ] || [ $mode = "lppbr-p256" ]
  then
  ...
  elif [ $mode = "lpdbr" ] || [ $mode = "lpdbr-p8" ] || [ $mode = "lpdbr-p16" ] || [ $mode = "lpdbr-p32" ] || [ $mode = "lpdbr-p64" ] || [ $mode = "lpdbr-p128" ] || [ $mode = "lpdbr-p256" ]
  then
