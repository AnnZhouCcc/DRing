...
run_cs_skewed(){
    ...
    # do
    k=3
    time ./run.sh RRG 1 64 16 graphfiles/ring_supergraph/double_ring/instance1_80_64.edgelist 2988 1 1 ${MAKE} FEW_TO_SOME ${mult} ${routing} ${k} ${C} ${S} 3 dring_${routing}_80_64_1 | grep "FCT" > fct_results_${date}/dring_${routing}_${k}_${tm}_${date}_ii${mult}_${lan} &
    # sleep 30
    # time ./run.sh RRG 1 64 16 graphfiles/ring_supergraph/rrg/instance1_80_64.edgelist 3072 1 1 ${MAKE} FEW_TO_SOME ${mult} ${routing} ${k} ${C} ${S} 3 rrg_${routing}_80_64_1 | grep "FCT" > fct_results_${date}/rrg_${routing}_${k}_${tm}_${date}_ii${mult}_${lan} &
    # sleep 30
...
run_a2a(){
    ...
    # do
    time ./run.sh RRG 1 64 16 graphfiles/ring_supergraph/double_ring/instance1_80_64.edgelist 2988 1 1 ${MAKE} RANDOM ${sr} ${routing} ${k} ${sr} 0 3 dring_${routing}_80_64_1 | grep "FCT" > fct_results_${date}/dring_${routing}_${k}_${tm}_${date}_sr${sr}_${lan} &
    sleep 5
    time ./run.sh RRG 1 64 16 graphfiles/ring_supergraph/rrg/instance1_80_64.edgelist 3072 1 1 ${MAKE} RANDOM ${sr} ${routing} ${k} ${sr} 0 3 rrg_${routing}_80_64_1 | grep "FCT" > fct_results_${date}/rrg_${routing}_${k}_${tm}_${date}_sr${sr}_${lan} &
    # sleep 5
