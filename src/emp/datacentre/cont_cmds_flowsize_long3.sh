...
k=32
rstag=32short
date=0603onet200clusterbinterval132shortlp1delay
...
run_cluster(){
    ...
    dp=6
    pwfile="pathweightfiles/clusterb/rrg/32short/pathweight_lp1_rrg_32short_clusterb_24000_27000_6dp.txt"
    ...
    numerator=0
    denominator=0
    for mult in 2 4 6 8 10 12 14 16 18; do
    name=run1
