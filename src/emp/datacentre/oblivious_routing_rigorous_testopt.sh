...
dir=oblivious_routing_discover_testopt_${topology}_${routing}_${trafficmatrix}_${mode}_${n}_${seednumpw}_${seednumtraffic}_$pwnum
if [ ! -d $dir ]
then
...
suffix=${topology}_${routing}_${trafficmatrix}_${mode}_${n}_${seednumpw}_${seednumtraffic}_$pwnum
