...
for suffix in trafficfilesuffixlist:
    trafficfile = f"{homedir}/DRing/src/emp/datacentre/trafficfiles/{trafficfilename}/traffic_64racks_{suffix}"
...
resultfile = f"{homedir}/DRing/src/emp/datacentre/computerouting2/output/spatial_{tag}"
