...
outputfileprefix1=${dir}/${mult1}_${numerator1}_${denominator1}_${stime}_${precision}
...
outputfileprefix2=${dir}/${mult2}_${numerator2}_${denominator2}_${stime}_${precision}
