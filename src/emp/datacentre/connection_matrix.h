...
class ConnectionMatrix{
 public:
  ...
  void setRandomFlows(int conns, double simtime_ms);
  ...
  void setFlowsFromClusterXSmallInterval(Topology* top, string cluster, int multiplier, int numerator, int denominator, int solvestart, int solveend, int solveinterval, double simtime_ms);
