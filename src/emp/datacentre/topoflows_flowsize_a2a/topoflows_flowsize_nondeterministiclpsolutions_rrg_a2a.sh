...
run_lp(){
    ...
    pwfile="pathweightfiles/rrg/ecmp/pathweight_rrg_ecmp_a2a_lp1_primalsimplex_64.txt"
    stime=200
    mstart=50
    mend=150
    denominator=10
    ...
    pwfile="pathweightfiles/rrg/ecmp/pathweight_rrg_ecmp_a2a_lp1_dualsimplex_64.txt"
    ...
    pwfile="pathweightfiles/rrg/ecmp/pathweight_rrg_ecmp_a2a_lp1_barrierwithcrossover_64.txt"
    ...
    pwfile="pathweightfiles/rrg/ecmp/pathweight_rrg_ecmp_a2a_lp1_barriernocrossover_64.txt"
